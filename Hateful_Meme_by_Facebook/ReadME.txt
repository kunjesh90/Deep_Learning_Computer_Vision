...
Given a meme id, meme image file, and a string representing the text in the meme image, 
trained model should output the probability that the meme is hateful.
